...
#
# Write a function named `calculate_area_triangle` that takes 
# the base and height of a triangle and returns the area.
...
def calculate_area_triangle(base, height):
    base_and_height = base * height
    total = base_and_height / 2
    print(total)

print('Exercise 1:', calculate_area_triangle(10, 5))
print('Exercise 1 (alt):', calculate_area_triangle(7, 3))
print('E1 - Complete')
print('========================================================')
...
print('Exercise 2 (alt):', simple_interest(1500, 3.5, 5))
print('E2 - Complete')
print('========================================================')
...
def apply_discount(price, discount):
    discount_cal = price * (discount / 100)

    sale_price = price - discount_cal
